...
#include <SoftwareSerial.h> //For wireless module
...
Servo left_font_motor;   // create servo object to control Vex Motor Controller 24
...
void setup(void) {
  ...
  SerialCom->println("Straight_Code");
  delay(1000);
...
STATE running() {
  ...
  if (millis() - previous_millis > 500) {  //Arduino style 500ms timed execution statement
    ...
    speed_change_smooth();
    // Analog_Range_A4(); //Reading IR on pin A4
